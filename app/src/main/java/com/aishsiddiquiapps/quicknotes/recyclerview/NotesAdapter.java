package com.aishsiddiquiapps.quicknotes.recyclerview;
...
public class
NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteViewHolder> {
...
//        }, 500);
//    }
public boolean searchNotes(String searchKeyword) {
    if (searchKeyword.trim().isEmpty()) {
        notes = notesSource;
    } else {
        ArrayList<Note> temp = new ArrayList<>();
